  ...
  <div class="content">
   ...
   <div class="news-item">
    ...
    <div class="news-content">
     <h3>
     <<a href="<?=URLROOT?>/Child/childCrePoem">Creative Story Writing</a>
     </h3>
     <p>
   ...
   <div class="news-item">
    ...
    <div class="news-content">
     <h3>
     <<a href="<?=URLROOT?>/Child/childCrePoem">Creative Poem Writing</a>
     </h3>
     <p>
   ...
   <div class="news-item">
    ...
    <div class="news-content">
     <h3>
     <a href="<?=URLROOT?>/Child/childCreSong">Creative Song Writing</a>
     </h3>
     <p>
