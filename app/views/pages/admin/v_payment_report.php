                ...
                <div class="report-summary">
                    ...
                    foreach ($data['payments'] as $payment) {
                        if ($payment->status == 'completed') {
                            ...
                            if ($payment->payment_type == 'Book Purchase') {
                                $bookSales += $payment->amount;
                                $bookCount++;
                            } else if ($payment->payment_type == 'Token Purchase') {
                    ...
                    <div class="summary-card">
                        <h3>Book Sales</h3>
                        <div class="value">KES <?php echo number_format($bookSales, 2); ?></div>
                        <div class="label"><?php echo $bookCount; ?> books sold</div>
                    </div>
                    <div class="summary-card">
                        <h3>Token Sales</h3>
                        <div class="value">KES <?php echo number_format($tokenSales, 2); ?></div>
