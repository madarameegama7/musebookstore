...
<body>
    ...
    <div class="main-content">
        ...
        <?php extract($data); ?>
        <?php require APPROOT . '/views/pages/parent/v_userprofilestats.php'; ?>
            ...
            <form action="<?php echo URLROOT; ?>/users/edit_profile" method="POST" class="profile-form">
                ...
                <div class="profile-column">
                    ...
                    <input type="text" id="name" name="name"
                        value="<?php echo htmlspecialchars($_SESSION['user_name']); ?>" disabled>
                ...
                <div style="width: 100%; text-align: center;">
                    ...
                    <button type="submit" name="saveprofile" id="saveBtn" class="save-btn" style="display: none;">Save
                        Changes</button>
                </div>
            </form>
