...
<link rel="stylesheet" href="<?= URLROOT ?>/css/viewSinglePost.css">
...
<div class="single-post-container">
    <?php if (!empty($data['post'])): ?>
        ...
        <div class="post-actions">
            ...
            <form action="<?= URLROOT ?>/communities/deletePost/<?= $data['post']->id ?>" method="POST" onsubmit="return confirm('Are you sure you want to permanently delete this post?');">
