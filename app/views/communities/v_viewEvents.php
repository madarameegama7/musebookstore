...
<div class="community-events-page">
    <div class="community-events-container">
        ...
        <a href="<?php echo URLROOT; ?>/communities/createEvent/<?php echo $data['community_id']; ?>" class="btn-create-event">Create Event</a>
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: [
            <?php foreach ($data['events'] as $event): ?>
            {
                ...
                url: '<?php echo URLROOT; ?>/communities/viewEventDetails/<?php echo $event->event_id; ?>'
            },
            <?php endforeach; ?>
        ]
    });
